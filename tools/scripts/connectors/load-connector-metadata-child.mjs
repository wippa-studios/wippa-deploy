 ...
 * `connector-script-utils.ts:loadConnectorFromFolder` so that the piece's
 * `require('@wippa/connectors-framework')` resolves via standard
 ...
 *
 * Usage: node load-connector-metadata-child.mjs <pieceDistFolder>
 */
...
if (!piece) {
    console.error(`[load-connector-metadata-child] no Piece export found in ${entryPath}`)
    process.exit(3)
}

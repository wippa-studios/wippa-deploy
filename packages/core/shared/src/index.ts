...
// Foundation utilities/types live in @wippa/core-utils; shared re-exports the whole
...
// @wippa/core-execution (SRE-163); shared re-exports them for backward compat.
...
export * from './lib/ee/connector-set'

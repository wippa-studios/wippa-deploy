import { createTrigger, PieceAuth, TriggerStrategy } from '@wippa/connectors-framework';
import { tablesCommon } from '../common';
import { PopulatedRecord, TableWebhookEventType } from '@wippa/connectors-framework';

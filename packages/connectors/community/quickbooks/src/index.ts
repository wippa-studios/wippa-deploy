import { createConnector, OAuth2PropertyValue, PieceAuth, PiecePropValueSchema, Property } from "@wippa/connectors-framework";
...
export const quickbooks = createConnector({

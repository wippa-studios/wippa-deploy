import { ApId, apId, SeekPage } from '@wippa/core-utils'
import { wideEvent } from '@wippa/server-utils'
import { AppConnectionScope, AppConnectionWithoutSensitiveData, ApplicationEventName, ListGlobalConnectionsRequestQuery, PrincipalType, SERVICE_KEY_SECURITY_OPENAPI, UpdateGlobalConnectionValueRequestBody, UpsertGlobalConnectionRequestBody } from '@wippa/shared'

import { ActivepiecesError, apId, deleteProps, ErrorCode, isNil, SeekPage } from '@wippa/core-utils'
import { ListOAuth2AppRequest, OAuthApp, UpsertOAuth2AppRequest } from '@wippa/shared'

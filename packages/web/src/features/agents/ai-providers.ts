...
`),
    logoUrl: 'https://cdn.wippa.com.au/pieces/claude.png',
  },
  {
    provider: AIProviderName.BEDROCK,
    name: 'AWS Bedrock',
    logoUrl: 'https://cdn.wippa.com.au/pieces/amazon-bedrock.png',
...
5. In the [AWS Bedrock Console](https://console.aws.amazon.com/bedrock/), go to **Model access** and request access to the models you want to use.`),
  },
  {
    ...
    name: 'Azure',
    logoUrl: 'https://cdn.wippa.com.au/pieces/azure-openai.png',
    markdown: t(
  ...
  },
  {
    ...
    logoUrl: 'https://cdn.wippa.com.au/pieces/cloudflare-gateway.png',
    markdown:
...
`),
    logoUrl: 'https://cdn.wippa.com.au/pieces/google-gemini.png',
  },
  {
    provider: AIProviderName.MISTRAL,
    name: 'Mistral AI',
    logoUrl: 'https://cdn.wippa.com.au/pieces/mistral-ai.png',
...
`),
    logoUrl: 'https://cdn.wippa.com.au/pieces/openai.png',
  },
  {
    provider: AIProviderName.OPENROUTER,
    name: 'OpenRouter',
    logoUrl: 'https://cdn.wippa.com.au/pieces/openrouter.jpg',
...
2. Once on the website, locate and click on the option to obtain your OpenRouter API Key.`),
  },
  {
    ...
    logoUrl: 'https://cdn.wippa.com.au/pieces/new-core/text-ai.svg',
    markdown:
